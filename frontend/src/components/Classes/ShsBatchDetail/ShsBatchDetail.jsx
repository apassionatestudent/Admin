...
export default function ShsBatchDetail() {
  ...
  const fetchMiscFees = async () => {
    ...
    try {
      const res = await axiosAdmin.get(`/api/admin/batches/shs/${publicId}/misc-fees`);
  ...
  const handleAddMiscFee = async () => {
    ...
    setAddingFee(true);
    try {
      await axiosAdmin.post(`/api/admin/batches/shs/${publicId}/misc-fees`, {
    ...
    <div className="adm-shs-batch-detail-page">
      ...
      <ConfirmModal
        ...
        onConfirm={async () => {
          ...
          try {
            const res = await axiosAdmin.patch(`/api/admin/batches/shs/${publicId}/bulk-release`);
            await fetchDetail(true);
            await fetchLogs();
